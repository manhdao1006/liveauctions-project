    ...
    <div class="container-fluid">
        <div class="row justify-content-evenly m-0 mt-3 mb-3">
            <div class="card-header col-xl-6">
                <h5 class="card-title mb-0">Thêm mới phiên đấu giá</h5>
            </div>
...
<script lang="ts">
    ...
    import { addPhienDauGia } from '@/services/nhanvien/phienDauGiaService'
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const handleThemMoi = async () => {
                ...
                const response = await addPhienDauGia(formData)
                if (response.success) {
