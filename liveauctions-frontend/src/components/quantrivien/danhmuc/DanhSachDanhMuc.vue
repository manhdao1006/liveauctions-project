        ...
        <div class="col-12 col-lg-12 col-xxl-12 d-flex">
            <div class="card flex-fill">
                ...
                <table class="table table-hover my-0">
                    ...
                    <tbody>
                        <tr v-for="(danhMuc, index) in paginatedDanhMucs" :key=" typeof danhMuc.maDanhMuc === 'string' ? danhMuc.maDanhMuc : undefined">
                            ...
                            <td>
                                <router-link :to="{ name: 'DanhSachDanhMucConView', params: { maDanhMuc: Number(danhMuc.maDanhMuc) } }">
                                    <i class="fa-solid fa-layer-group text-warning" title="Xem cấp con"></i>
                                </router-link>
                                |
                                <router-link :to="{ name: 'CapNhatDanhMucView', params: { maDanhMuc: Number(danhMuc.maDanhMuc) } }">
...
<script lang="ts">
    ...
    import { deleteDanhMuc, getDanhMucs } from '@/services/quantrivien/danhMucService'
