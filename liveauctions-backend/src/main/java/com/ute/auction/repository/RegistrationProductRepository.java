...
public interface RegistrationProductRepository extends JpaRepository<RegistrationProductEntity, Long> {
    ...
    @Query(value = "SELECT rp.id, rp.name, rp.starting_price, rp.status, rp.registration_date, rp.description, rp.del_flag, rp.seller_id, rp.sub_category_id, rp.auction_format_id " + 
                    "FROM registration_product rp " + 
                    "WHERE rp.seller_id like ?1 " + 
                    "ORDER BY rp.starting_price ASC", 
            countQuery = "SELECT COUNT(rp.id) FROM registration_product rp WHERE rp.seller_id = ?1",
            nativeQuery = true)
    Page<RegistrationProductEntity> sortedAscByStartingPrice(Long sellerId, Pageable pageable);

    @Query(value = "SELECT rp.id, rp.name, rp.starting_price, rp.status, rp.registration_date, rp.description, rp.del_flag, rp.seller_id, rp.sub_category_id, rp.auction_format_id " + 
                    "FROM registration_product rp " + 
                    "WHERE rp.seller_id like ?1 " + 
                    "ORDER BY rp.starting_price DESC", 
            countQuery = "SELECT COUNT(rp.id) FROM registration_product rp WHERE rp.seller_id = ?1",
            nativeQuery = true)
    Page<RegistrationProductEntity> sortedDescByStartingPrice(Long sellerId, Pageable pageable);
    ...
    @Query(value = "SELECT rp.id, rp.name, rp.starting_price, rp.status, rp.registration_date, rp.description, rp.del_flag, rp.seller_id, rp.sub_category_id, rp.auction_format_id " + 
            ...
            countQuery = "SELECT COUNT(rp.id) FROM registration_product rp WHERE rp.seller_id = ?1",
            nativeQuery = true)
    Page<RegistrationProductEntity> sortedAscByRegistrationDate(Long sellerId, Pageable pageable);
    ...
    @Query(value = "SELECT rp.id, rp.name, rp.starting_price, rp.status, rp.registration_date, rp.description, rp.del_flag, rp.seller_id, rp.sub_category_id, rp.auction_format_id " + 
            ...
            countQuery = "SELECT COUNT(rp.id) FROM registration_product rp WHERE rp.seller_id = ?1",
            nativeQuery = true)
    Page<RegistrationProductEntity> sortedDescByRegistrationDate(Long sellerId, Pageable pageable);
