...
public interface AuctionHistoryRepository extends JpaRepository<AuctionHistoryEntity, AuctionHistoryId> {
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                        ...
                        " JOIN [user] u ON b.buyer_id = u.id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'" + 
                        " ORDER BY ah.auctioned_price ASC", 
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        " JOIN product p ON ah.product_id = p.id" + 
                        " JOIN seller s ON p.seller_id = s.seller_id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedAscByAuctionedPrice(Long sellerId, Pageable pageable);
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                        ...
                        " JOIN [user] u ON b.buyer_id = u.id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'" + 
                        " ORDER BY ah.auctioned_price DESC", 
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        " JOIN product p ON ah.product_id = p.id" + 
                        " JOIN seller s ON p.seller_id = s.seller_id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedDescByAuctionedPrice(Long sellerId, Pageable pageable);
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                ...
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        ...
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedAscByOrderDate(Long sellerId, Pageable pageable);
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                        ...
                        " JOIN [user] u ON b.buyer_id = u.id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'" + 
                        " ORDER BY ah.order_date DESC", 
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        " JOIN product p ON ah.product_id = p.id" + 
                        " JOIN seller s ON p.seller_id = s.seller_id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedDescByOrderDate(Long sellerId, Pageable pageable);
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                        ...
                        " JOIN [user] u ON b.buyer_id = u.id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'" + 
                        " ORDER BY ah.delivery_date ASC", 
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        " JOIN product p ON ah.product_id = p.id" + 
                        " JOIN seller s ON p.seller_id = s.seller_id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedAscByDeliveryDate(Long sellerId, Pageable pageable);
        ...
        @Query(value = "SELECT ah.auction_id, ah.buyer_id, ah.fee_id, ah.holiday_id, ah.product_id, ah.bid_time, ah.delivery_date, ah.status," + 
                        ...
                        " JOIN [user] u ON b.buyer_id = u.id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'" + 
                        " ORDER BY ah.delivery_date DESC", 
                countQuery = "SELECT COUNT(ah.product_id) FROM auction_history ah" + 
                        " JOIN product p ON ah.product_id = p.id" + 
                        " JOIN seller s ON p.seller_id = s.seller_id" + 
                        " WHERE s.seller_id like ?1 AND ah.status like 'done'", 
                nativeQuery = true)
        Page<AuctionHistoryEntity> sortedDescByDeliveryDate(Long sellerId, Pageable pageable);
